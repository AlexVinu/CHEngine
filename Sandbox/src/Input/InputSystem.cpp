...
InputSystem::InputSystem()
    : m_ContextStack{ InputContext::Editor }
{
}
...
void InputSystem::PushContext(InputContext ctx)
{
    m_ContextStack.push_back(ctx);
}

void InputSystem::PopContext(InputContext ctx)
{
...
bool InputSystem::IsActiveContext(InputContext ctx) const
{
