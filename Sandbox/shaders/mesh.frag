...
vec3 CalcLight(int index, vec3 normal, vec3 viewDir, float specularMask)
{
    ...
    vec3  specular = 0.5 * spec * specularMask * lightCol * material.SpecularScale;
...
void main()
{
    ...
    vec3 baseColor = (material.UseTexture > 0)
    ...
    float specMask = (material.UseSpecularMap > 0)
